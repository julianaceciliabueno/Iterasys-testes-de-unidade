import pytest #biblioteca



#isso faz alguma coisa ex uma receita(o parenteses na def:recebe informação, nas demais envia a informação)
def imprimir_oi(nome):
    print(f'Oi, {nome}') #o f (fancy) indica um texto fixo.
...
#usos teste unitário todo teste é feito em 3 partes.
def teste_somar():
